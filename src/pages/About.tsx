          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                A backend developer passionate about digital health solutions,
                with a focus on telemedicine in Nigeria. I combine technical
                skills with creative problem-solving to deliver effective
                solutions.
              </p>
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden">
                <img
                  ...
                  src="/lovable-uploads/3dd6aa38-9148-4a2e-8557-568f70d2b103.jpg"
                />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-700 mb-4">
                ...
                obsession: building systems that actually work — fast, reliable,
                scalable, and user-friendly. Today, I specialize in helping
                startups and founders turn big ideas into production-ready web
                apps using Next.js, Node.js, and modern backend architectures.
              </p>
              <p className="text-gray-700">
                I’m especially driven by the impact of digital health innovation
                in Nigeria — leveraging code to bridge healthcare gaps and build
                telemedicine platforms that deliver care where it’s needed most.
              </p>
              <br />
              <p className="text-gray-700">
                Whether it's an MVP, admin dashboard, or CMS integration, I
                don’t just ship features — I solve real problems with clean,
                scalable code.
              </p>
            </div>
                  ...
                  {[
                    {
                      ...
                      image:
                        "/lovable-uploads/52ceb164-6d45-4ab2-adc8-43ff45399768.png",
                    ...
                    },
                    {
                      ...
                      image:
                        "/lovable-uploads/ef8e1304-09a5-4ade-8c0c-93dab1808484.png",
                    ...
                    },
                    {
                      ...
                      image:
                        "/lovable-uploads/031dc977-121b-4469-a7ce-a090ecdcdade.png",
