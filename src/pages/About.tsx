          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="rounded-2xl overflow-hidden">
                <img alt="Code on computer screen" className="w-full h-auto object-cover" src="/lovable-uploads/3dd6aa38-9148-4a2e-8557-568f70d2b103.jpg" />
              </div>
      ...
      <div>
        ...
        <div className="space-y-6">
          {[{
                ...
                points: ["Led the full-stack development of an admin dashboard, improving user efficiency by 35%.", "Built scalable systems with Next.js, MongoDB, Mongoose, and Tailwind CSS.", "Improved database performance by 25% with optimized querying and security."]
              }, {
                title: "Lead Software Developer",
                org: "Nextage Digital Solutions Ltd.",
                color: "text-accent-blue",
                date: "Nov 2024 – Present",
                points: ["Spearheaded product development, increasing delivery speed by 40%.", "Drove cross-functional team efficiency with strong communication.", "Used Sanity, Next.js, and TypeScript to achieve high-performance builds."]
              }, {
                title: "Frontend Developer",
                org: "Rawaaq",
                color: "text-accent-pink",
                date: "Dec 2024 - Present",
                points: ["Built educational dashboards and CMS platforms.", "Contributed to frontend/backend logic for fast release cycles.", "Designed responsive, accessible interfaces for better engagement."]
              }].map(({
                title,
                org,
                color,
                date,
                points
              }, idx) => <div key={idx} className="glass p-6 rounded-xl">
        ...
        <div>
          ...
          <div className="space-y-6">
            {[ {
                  ...
                  year,
                  note
                }, i) => <div key={i} className="glass p-6 rounded-xl">
                <div className="flex justify-between items-start mb-2">
          ...
          <div className="space-y-4">
            {[{
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-4">
                  {image && <div className="w-full md:w-24 h-24 flex-shrink-0">
                  ...
                  <div className="flex-grow">
                    ...
                    {link && <a href={link} target="_blank" rel="noopener noreferrer" className="text-xs flex items-center text-accent-blue hover:underline">
